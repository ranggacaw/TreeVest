...
class TreeResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'min_investment_idr' => $this->min_investment_idr,
            'max_investment_idr' => $this->max_investment_idr,
            'min_investment_formatted' => 'Rp '.number_format($this->min_investment_idr, 0, ',', '.'),
            'max_investment_formatted' => 'Rp '.number_format($this->max_investment_idr, 0, ',', '.'),
