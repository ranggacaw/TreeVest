  ...
  if (compact) {
    return (
      <div className="flex items-center gap-1 text-sm text-gray-600">
        <span className="font-medium text-xs">{farm.name}</span>
        {warehouse && (
          <>
        ...
        {rack && (
          <>
            <span className="text-gray-400">›</span>
            <span className="text-xs">{rack.name}</span>
          </>
        )}
        {lot && (
          <>
            <span className="text-gray-400">›</span>
            <span className="font-medium text-green-600 text-xs">{lot.name}</span>
          </>
        )}
        {tree && (
          <>
            <span className="text-gray-400">›</span>
            <span className="text-blue-600 text-xs">Tree {tree.tree_identifier}</span>
          </>
        )}
      </div>
    );
