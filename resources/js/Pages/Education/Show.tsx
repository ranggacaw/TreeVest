                ...
                <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                        ...
                        <div className="p-8">
                            <div className="mb-4 flex flex-wrap items-center gap-2">
                                {article.categories.map((category) => (
                                    <Link
                                        key={category.id}
                                        href={route('education.index', { category: category.slug })}
                                        className="rounded-full bg-indigo-100 px-3 py-1 text-sm font-semibold text-indigo-800 hover:bg-indigo-200"
                                    >
                                        {category.name}
                                    </Link>
                                ))}
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-1 flex-col p-4">
                                            <h3 className="mb-2 text-lg font-semibold text-gray-900">
                                                <Link
                                                    href={route('education.show', related.slug)}
                    ...
                    <div className="mt-8 rounded-lg bg-yellow-50 p-6">
                        ...
                        <p className="text-sm text-yellow-800">
                            ...
                            financial advice. All investments involve risk. Please consult with a
