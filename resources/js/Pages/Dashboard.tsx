            ...
            header={
                <div className="flex justify-between items-center">
                    ...
                    {!needsKyc && (
                        <Link
                            href="/farms"
                            className="hidden sm:inline-flex items-center px-4 py-2 bg-pine text-sand rounded-xl font-semibold text-sm hover:bg-pine-800 transition-colors shadow-soft"
                        >
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div className="bg-white rounded-3xl shadow-card border border-sand-200 overflow-hidden">
                        <div className="p-12 text-center flex flex-col items-center justify-center min-h-[400px]">
                            <div className="w-24 h-24 bg-sand-100 rounded-full flex items-center justify-center mb-6">
                                <svg className="w-12 h-12 text-pine-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
