...
<body>
    ...
    <div class="summary-box">
        ...
        <div class="summary-row">
            ...
            <span>RM {{ number_format($data['profitLoss']['summary']['totalInvestedCents'] / 100, 2) }}</span>
        </div>
        <div class="summary-row">
            <span class="summary-label">Total Payouts Received:</span>
            <span>RM {{ number_format($data['profitLoss']['summary']['totalPayoutsCents'] / 100, 2) }}</span>
        </div>
        <div class="summary-row">
            <span class="summary-label">Net Return:</span>
            <span class="{{ $data['profitLoss']['summary']['netCents'] >= 0 ? 'positive' : 'negative' }}">
                RM {{ number_format($data['profitLoss']['summary']['netCents'] / 100, 2) }}
            </span>
        </div>
        <div class="summary-row">
    ...
    <div class="disclaimer">
        <p><strong>Disclaimer:</strong> This report is generated by Treevest for informational purposes only. All financial figures are based on actual investment and payout data recorded in the platform. Past performance is not indicative of future results. This report should not be considered as financial or investment advice. For tax purposes, please consult with a qualified tax professional. The data in this report is accurate as of the generation timestamp.</p>
    </div>
</body>
</html>
