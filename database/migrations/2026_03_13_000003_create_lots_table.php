...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('lots', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('base_price_per_tree_idr');
            $table->decimal('monthly_increase_rate', 5, 4)->default(0.0000);
            $table->unsignedBigInteger('current_price_per_tree_idr');
            ...
            // Selling fields
            $table->unsignedBigInteger('selling_revenue_idr')->nullable();
